...
<head>
    ...
    <title>GoAircon | New Account</title>
            ...
            <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-danger">${n_error}</h6><br>
                    
                    <form action="newAccount" method="get">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Phone Number <small>${p_error }</small></label>
                          <input type="text" name="phone" class="form-control" id="exampleInputPhone" aria-describedby="emailHelp" placeholder="Enter phone">
                        ...
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="exampleCheck1">Check me out</label><small>T&C apply</small>
                        </div><br>
                        <button type="submit" class="btn btn-primary">Create</button><a href="UserLogin" class="btn btn-link">Login</a>
                      </form>
